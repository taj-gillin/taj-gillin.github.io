...
The goal of this project was to train a self-supervised learning model on the [galaxy10_decals](https://huggingface.co/datasets/matthieulel/galaxy10_decals) dataset, then use the learned encoder to train a downstream classifier. The dataset is a collection of 17,736 256×256 images of galaxies, with 10 different classes. I chose to use the [MAE](https://arxiv.org/pdf/2111.06377) (Masked Autoencoder) architecture.
